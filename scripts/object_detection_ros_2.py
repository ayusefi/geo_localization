...
with detection_graph.as_default():
  with tf.Session(graph=detection_graph) as sess:
    while not rospy.is_shutdown():
      ...
      msg_park.header.frame_id="None"
      print (msg_park.header.frame_id)
      msg_park.twist.linear.x = 0
      msg_park.twist.linear.y = 0
      msg_park.twist.linear.z = 0
      msg_park.twist.angular.x = 0
      msg_park.twist.angular.y = 0  
